...
urlpatterns = [
    ...
    path("enhancededges/", views.EnhancedEdgeListView.as_view(), name="enhanced_edges_index"),
    ...
    path("transformations/", views.TransformationListView.as_view(), name="transformations_index"),
