...
always_prepared = Edge.objects.create(
    name="Always Prepared",
    ratings=[1],
)
artistic_talent = Edge.objects.create(
    name="Artistic Talent",
    ratings=[1, 2, 3],
)
danger_sense = Edge.objects.create(
    name="Danger Sense",
    ratings=[1],
)
direction_sense = Edge.objects.create(
    name="Direction Sense",
    ratings=[1],
)
ironwill = Edge.objects.create(
    name="Iron Will",
    ratings=[1, 2, 3],
)
library = Edge.objects.create(
    name="Library",
    ratings=[1, 2, 3],
)
lightning_calculator = Edge.objects.create(
...
adrenaline_spike = Edge.objects.create(
    name="Adrenaline Spike",
    ratings=[2],
)
ambidextrous = Edge.objects.create(
    name="Ambidextrous",
    ratings=[1],
)
breath_control = Edge.objects.create(
    name="Breath Control",
    ratings=[1],
)
...
hair_trigger_reflexes = Edge.objects.create(
...
hardy = Edge.objects.create(
    name="Hardy",
    ratings=[1, 2, 3],
)
ms_fix_it = Edge.objects.create(
    name="Ms. Fix It",
    ratings=[2],
)
swift = Edge.objects.create(
    name="Swift",
    ratings=[1],
)
tough_cookie = Edge.objects.create(
    name="Tough Cookie",
    ratings=[2],
)
weak_spots = Edge.objects.create(
    name="Weak Spots",
    ratings=[1],
)
...
animal_ken = Edge.objects.create(
    name="Animal Ken",
    ratings=[1, 2],
)
big_hearted = Edge.objects.create(
    name="Big Hearted",
    ratings=[1],
)
covert = Edge.objects.create(name="Covert", ratings=[1, 2, 3], prereqs=[[("path", 3)]])
fame = Edge.objects.create(
    name="Fame",
    ratings=[1, 2, 3],
)
patron = Edge.objects.create(name="Patron", ratings=[1, 2, 3], prereqs=[[("path", 1)]])
safe_house = Edge.objects.create(
    name="Safe House",
    ratings=[1],
)
skilled_liar = Edge.objects.create(
    name="Skilled Liar",
    ratings=[2],
)
striking = Edge.objects.create(
    name="Striking",
    ratings=[2],
)
wealth = Edge.objects.create(
    name="Wealth",
    ratings=[1, 2, 3, 4, 5],
)
...
artifact = Edge.objects.create(
    name="Artifact",
    ratings=[1, 2, 3, 4, 5],
)
endurance = Edge.objects.create(
    name="Endurance",
    ratings=[3],
)
...
superior_trait_might = Edge.objects.create(
    name="Superior Trait (Might)",
    ratings=[2],
)
...
attunement = Edge.objects.create(
    name="Attunement",
    ratings=[1, 2, 3, 4, 5],
)
dormancy = Edge.objects.create(
    name="Dormancy",
    ratings=[1, 2],
)
eufiber = Edge.objects.create(
    name="Eufiber",
    ratings=[1, 2, 3, 4, 5],
)
...
q_tech = MegaEdge.objects.create(
    name="Q-Tech",
    ratings=[1, 2, 3, 4, 5, 6, 7, 8, 9],
)
quantum_conversion = MegaEdge.objects.create(
...
telecommunication = MegaEdge.objects.create(
...
broad = Tag.objects.create(
    name="Broad",
    ratings=[2],
)
broad.permitted_powers.add(absorption)
broad.save()
siphon = Tag.objects.create(
    name="Siphon",
    ratings=[1],
)
...
continuous = Tag.objects.create(
    name="Continuous",
    ratings=[1],
)
continuous.permitted_powers.add(environmental_anima)
continuous.save()
non_terrestrial = Tag.objects.create(
...
form_mastery = Tag.objects.create(
    name="Form Mastery",
    ratings=[1],
)
...
restricted_to_phase_state = Tag.objects.create(
    name="Restricted to Phase State",
    ratings=[-1],
)
...
extra_traits = Tag.objects.create(
    name="Extra Traits",
    ratings=[1],
)
extra_traits.permitted_powers.add(transformation)
extra_traits.save()
reflexive = Tag.objects.create(
    name="Reflexive",
    ratings=[2],
)
