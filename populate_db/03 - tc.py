...
gun_tool = Trick.objects.create(name="Gun Tool", skill="aim",)
hidden_arsenal = Trick.objects.create(name="Hidden Arsenal", skill="aim",)
Trick.objects.create(
    name="I Wasn't Aiming at You", skill="aim",
)
Trick.objects.create(
    name="Shoot to Injure", skill="aim",
)
Trick.objects.create(
    name="It's All in the Reflexes", skill="athletics",
)
Trick.objects.create(
    name="Mighty Lifter", skill="athletics",
)
Trick.objects.create(
    name="No Barrier", skill="athletics",
)
Trick.objects.create(
    name="Physical Actor", skill="athletics",
)
Trick.objects.create(
    name="Deadly Strike", skill="close_combat",
)
Trick.objects.create(
    name="Sucker Punch", skill="close_combat",
)
Trick.objects.create(
    name="Fast Planning", skill="close_combat",
)
Trick.objects.create(
    name="Inspiring Example", skill="command",
)
Trick.objects.create(
    name="Motivational Speaker", skill="command",
)
Trick.objects.create(
    name="Top Dog", skill="command",
)
Trick.objects.create(
    name="Grain of Truth", skill="culture",
)
Trick.objects.create(
    name="Members Only", skill="culture",
)
Trick.objects.create(
    name="That's My Favorite, Too!", skill="culture",
)
Trick.objects.create(
    name="Cold Reader", skill="empathy",
)
Trick.objects.create(
    name="Rumor Has It", skill="empathy",
)
Trick.objects.create(
    name="Six Degrees", skill="empathy",
)
Trick.objects.create(
    name="The Crack in the Ice", skill="empathy",
)
Trick.objects.create(
    name="Connecting the Dots", skill="empathy",
)
Trick.objects.create(
    name="Did the Math", skill="empathy",
)
Trick.objects.create(
    name="Elite Hacker", skill="enigmas",
)
Trick.objects.create(
    name="Instant Solution", skill="enigmas",
)
Trick.objects.create(
    name="Befuddling Jargon", skill="humanities",
)
Trick.objects.create(
    name="Everything in Context", skill="humanities",
)
Trick.objects.create(
    name="Legal Authority", skill="humanities",
)
Trick.objects.create(
    name="Meditative Stance", skill="integrity",
)
Trick.objects.create(
    name="Poker Face", skill="integrity",
)
Trick.objects.create(
    name="Strength of Conviction", skill="integrity",
)
Trick.objects.create(
    name="Tough Nut", skill="integrity",
)
Trick.objects.create(
    name="Always Have an Exit", skill="larceny",
)
Trick.objects.create(
    name="Handcuff Houdini", skill="larceny",
)
Trick.objects.create(
    name="Set a Thief", skill="larceny",
)
Trick.objects.create(
    name="That Was Already Mine", skill="larceny",
)
Trick.objects.create(
    name="Diagnostic Expert", skill="medicine",
)
Trick.objects.create(
    name="Medical Advantage", skill="medicine",
)
Trick.objects.create(
    name="Quick Aid", skill="medicine",
)
Trick.objects.create(
    name="Walking Wounded", skill="medicine",
)
Trick.objects.create(
    name="Captivating Personality", skill="persuasion",
)
Trick.objects.create(
    name="Devilishly Good Looking", skill="persuasion",
)
Trick.objects.create(
    name="Easy to Love", skill="persuasion",
)
Trick.objects.create(
    name="Backseat Driver", skill="pilot",
)
Trick.objects.create(
    name="Collision Artist", skill="pilot",
)
Trick.objects.create(
    name="Fighter Pilot", skill="pilot",
)
Trick.objects.create(
    name="I Can Figure It Out", skill="pilot",
)
Trick.objects.create(
    name="R&D Expert", skill="science",
)
Trick.objects.create(
    name="Scientific Method", skill="science",
)
Trick.objects.create(
    name="Scientific Polymath", skill="science",
)
Trick.objects.create(
    name="King of Beasts", skill="survival",
)
Trick.objects.create(
    name="Tricky Situation", skill="survival",
)
Trick.objects.create(
    name="Versus Wild", skill="survival",
)
Trick.objects.create(
    name="Without a Trace", skill="survival",
)
Trick.objects.create(
    name="Ahead of Your Time", skill="technology",
)
Trick.objects.create(
    name="Engineer's Eye", skill="technology",
)
...
photographic_memory = Edge.objects.create(
    name="Photographic Memory", ratings=[1, 2, 3],
)
small_unit_tactics = Edge.objects.create(
    name="Small Unit Tactics", ratings=[2], prereqs=[("path", 1)],
)
speed_reading = Edge.objects.create(
...
alternate_identity = Edge.objects.create(
...
superior_trait_intellect = Edge.objects.create(
    name="Superior Trait (Intellect)", ratings=[2]
)
superior_trait_cunning = Edge.objects.create(
    name="Superior Trait (Cunning)", ratings=[2]
)
superior_trait_resolve = Edge.objects.create(
    name="Superior Trait (Resolve)", ratings=[2]
)
superior_trait_might = Edge.objects.create(name="Superior Trait (Might)", ratings=[2],)
superior_trait_dexterity = Edge.objects.create(
    name="Superior Trait (Dexterity)", ratings=[2]
)
superior_trait_stamina = Edge.objects.create(
    name="Superior Trait (Stamina)", ratings=[2]
)
superior_trait_presence = Edge.objects.create(
    name="Superior Trait (Presence)", ratings=[2]
)
superior_trait_manipulation = Edge.objects.create(
    name="Superior Trait (Manipulation)", ratings=[2]
)
superior_trait_composure = Edge.objects.create(
...
borrowed_resources = Edge.objects.create(
...
friends_everywhere = Edge.objects.create(
    name="Friends Everywhere", ratings=[1, 2], prereqs=[("path", 1)]
)
microgravity_training = Edge.objects.create(
    name="Microgravity Training",
    ratings=[1, 2, 3],
    prereqs=[("path", 1), ("Direction Sense", 1)],
)
well_equipped = Edge.objects.create(
...
wondrous_item = EnhancedEdge.objects.create(
...
Gift.objects.create(
    name="A Friend in Every Port", keywords=["constant", "luck"], prereqs=[]
)
Gift.objects.create(
    name="A Great Memory for Faces", keywords=["constant", "luck"], prereqs=[]
)
...
Gift.objects.create(
    name="Name in the Lights", keywords=["constant", "luck"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="Voiding the Warranty", keywords=["momentary", "luck"], prereqs=[]
)
...
Gift.objects.create(
    name="Behold the Halo (Cunning)",
    keywords=["cunning", "momentary"],
    prereqs=[("cunning", 3)],
)
Gift.objects.create(
    name="Behold the Halo (Manipulation)",
...
Gift.objects.create(
    name="The Late, Late Shift (Composure)",
    keywords=["composure", "constant"],
    prereqs=[("composure", 2)],
)
Gift.objects.create(
    name="The Late, Late Shift (Resolve)",
    keywords=["resolve", "constant"],
    prereqs=[("resolve", 2)],
)
Gift.objects.create(
    name="The Late, Late Shift (Stamina)",
...
Gift.objects.create(
    name="Pretty Damned Fast", keywords=["dexterity", "momentary"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="The Room Where It Happens", keywords=["presence", "momentary"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="Indomitable Will (Integrity)",
    keywords=["resolve", "constant"],
    prereqs=[("integrity", 3)],
)
Gift.objects.create(
    name="An Extension of Myself (Aim)",
    keywords=["constant", "aim"],
    prereqs=[("aim", 3)],
)
Gift.objects.create(
    name="An Extension of Myself (Close Combat)",
    keywords=["constant", "close_combat"],
...
Gift.objects.create(
    ...
    keywords=["close_combat", "momentary"],
    prereqs=[("close_combat", 3)],
)
Gift.objects.create(
...
Gift.objects.create(
    name="Warrior's Eye", keywords=["momentary", "aim", "close_combat"], prereqs=[]
)
Gift.objects.create(
    name="Contortionist", keywords=["constant", "athletics"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="Lightning Reflexes (Athletics)",
    keywords=["constant", "athletics"],
    prereqs=[("athletics", 2)],
)
Gift.objects.create(
    name="Lightning Reflexes (Empathy)",
    keywords=["constant", "empathy"],
    prereqs=[("empathy", 2)],
)
Gift.objects.create(
...
Gift.objects.create(
    name="Say That To My Face (Close Combat)",
    keywords=["momentary", "close_combat"],
    prereqs=[("close_combat", 2)],
)
Gift.objects.create(
    name="Say That To My Face (Command)",
    keywords=["momentary", "command"],
    prereqs=[("command", 2)],
)
Gift.objects.create(
    name="After School Special (Command)",
    keywords=["momentary", "command"],
    prereqs=[("command", 4)],
)
Gift.objects.create(
    name="After School Special (Persuasion)",
    keywords=["momentary", "persuasion"],
    prereqs=[("persuasion", 4)],
)
Gift.objects.create(
...
Gift.objects.create(
    name="Public Education (Culture)",
    keywords=["momentary", "command", "culture"],
    prereqs=[("command", 2), ("culture", 3)],
)
Gift.objects.create(
    name="Public Education (Humanities)",
    keywords=["momentary", "command", "humanities"],
    prereqs=[("command", 2), ("humanities", 3)],
)
Gift.objects.create(
    name="Public Education (Science)",
    keywords=["momentary", "command", "science"],
    prereqs=[("command", 2), ("science", 3)],
)
Gift.objects.create(
    name="Public Education (Technology)",
    keywords=["momentary", "command", "technology"],
    prereqs=[("command", 2), ("technology", 3)],
)
Gift.objects.create(
    name="Rousing Speech", keywords=["momentary", "command"], prereqs=[]
)
Gift.objects.create(
    name="Theatre of Conflict", keywords=["momentary", "command"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="Cold Read", keywords=["constant", "culture", "empathy"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="The Right Climate (Culture)",
    keywords=["momentary", "culture"],
    prereqs=[("culture", 3)],
)
Gift.objects.create(
    name="The Right Climate (Empathy)",
    keywords=["momentary", "empathy"],
    prereqs=[("empathy", 3)],
)
Gift.objects.create(
    name="Ripped From the Headlines", keywords=["constant", "culture"], prereqs=[]
)
Gift.objects.create(
    name="That's Bad Luck", keywords=["constant", "culture"], prereqs=[]
)
...
Gift.objects.create(
    name="Deep System Scan (Enigmas)",
    keywords=["momentary", "enigmas"],
    prereqs=[("enigmas", 3)],
)
Gift.objects.create(
    name="Deep System Scan (Technology)",
...
Gift.objects.create(
    name="Irons in the Fire (Enigmas)",
    keywords=["momentary", "enigmas"],
    prereqs=[("enigmas", 3)],
)
Gift.objects.create(
    name="Irons in the Fire (Humanities)",
    keywords=["momentary", "humanities"],
    prereqs=[("humanities", 3)],
)
Gift.objects.create(
    name="Irons in the Fire (Medicine)",
    keywords=["momentary", "medicine"],
    prereqs=[("medicine", 3)],
)
Gift.objects.create(
    name="Irons in the Fire (Science)",
    keywords=["momentary", "science"],
    prereqs=[("science", 3)],
)
Gift.objects.create(
    name="Irons in the Fire (Technology)",
    keywords=["momentary", "technology"],
    prereqs=[("technology", 3)],
)
Gift.objects.create(
    name="Mystery Archaeology", keywords=["constant", "enigmas"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="No Stone Unturned", keywords=["constant", "humanities", "science"], prereqs=[]
)
Gift.objects.create(
    name="Repeating History", keywords=["momentary", "humanities"], prereqs=[]
)
Gift.objects.create(
    name="Steganographer",
...
Gift.objects.create(
    name="Reverse-Engineering Calamity", keywords=["momentary", "integrity"], prereqs=[]
)
Gift.objects.create(
    name="Self-Sense", keywords=["constant", "integrity", "medicine"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="Shameless Lying Smile (Persuasion)",
    keywords=["momentary", "persuasion"],
    prereqs=[("persuasion", 2)],
)
Gift.objects.create(
    name="Take it on the Chin", keywords=["momentary", "integrity"], prereqs=[]
)
Gift.objects.create(
    name="Unquestionable",
    keywords=["momentary", "integrity"],
...
Gift.objects.create(
    name="Slip the Cuffs (Technology)",
    keywords=["momentary", "technology"],
    prereqs=[("technology", 2)],
)
Gift.objects.create(
...
Gift.objects.create(
    name="Disarming Candor", keywords=["momentary", "persuasion"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="Steely Gaze (Presence)",
    keywords=["momentary", "persuasion"],
    prereqs=[("persuasion", 2), ("presence", 3)],
)
Gift.objects.create(
    name="Steely Gaze (Manipulation)",
    keywords=["momentary", "persuasion"],
    prereqs=[("persuasion", 2), ("manipulation", 3)],
)
Gift.objects.create(
    name="Steely Gaze (Composure)",
    keywords=["momentary", "persuasion"],
    prereqs=[("persuasion", 2), ("composure", 3)],
)
Gift.objects.create(
...
Gift.objects.create(
    name="Head 'Em Off At The Pass", keywords=["constant", "pilot"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="Discovery Rush", keywords=["momentary", "science"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="Internal Compass", keywords=["constant", "survival"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="Through Wild Eyes", keywords=["momentary", "survival"], prereqs=[]
)
Gift.objects.create(
...
Gift.objects.create(
    name="Cut the Red Wire", keywords=["momentary", "technology"], prereqs=[]
)
Gift.objects.create(
    name="Digital Crackerjack", keywords=["momentary", "technology"], prereqs=[]
)
Gift.objects.create(
...
adaptation = MegaEdge.objects.create(
...
universal_translator = MegaEdge.objects.create(
...
aberrant_eyes = Transformation.objects.create(name="Aberrant Eyes", level="low",)
anima_aura = Transformation.objects.create(name="Anima Aura", level="low",)
epidermal_shift = Transformation.objects.create(name="Epidermal Shift", level="low",)
feeding_requirement = Transformation.objects.create(
    name="Feeding Requirement", level="low",
)
inhuman_beauty = Transformation.objects.create(name="Inhuman Beauty", level="low",)
life_bane = Transformation.objects.create(name="Life Bane", level="low",)
psychological_shift = Transformation.objects.create(
    name="Psychological Shift", level="low",
)
vocal_shift = Transformation.objects.create(name="Vocal Shift", level="low",)
Transformation.objects.create(
    name="Allergic Reaction", level="medium",
)
Transformation.objects.create(
    name="Energy Bleed", level="medium",
)
Transformation.objects.create(
    name="Hypersensitivity", level="medium",
)
Transformation.objects.create(
    name="Physiological Shift", level="medium",
)
Transformation.objects.create(
    name="Power Loss", level="medium",
)
Transformation.objects.create(
    name="Psychological Disorder", level="medium",
)
Transformation.objects.create(
    name="Uncontrolled Dormancy", level="medium",
)
