...
WoDSpecialty.objects.get_or_create(name="Steely Grip", stat="strength")
WoDSpecialty.objects.get_or_create(name="Lower Body", stat="strength")
WoDSpecialty.objects.get_or_create(name="Strength Reserves", stat="strength")
WoDSpecialty.objects.get_or_create(name="Lightning Reflexes", stat="dexterity")
WoDSpecialty.objects.get_or_create(name="Preternatural Grace", stat="dexterity")
WoDSpecialty.objects.get_or_create(name="Nimble Fingers", stat="dexterity")
WoDSpecialty.objects.get_or_create(name="Unbreakable", stat="stamina")
...
WoDSpecialty.objects.get_or_create(name="Air of Confidence", stat="charisma")
WoDSpecialty.objects.get_or_create(name="Captivating Voice", stat="charisma")
WoDSpecialty.objects.get_or_create(name="Infectious Humor", stat="charisma")
WoDSpecialty.objects.get_or_create(name="Forked Tongue", stat="manipulation")
WoDSpecialty.objects.get_or_create(name="Unswerving Logic", stat="manipulation")
WoDSpecialty.objects.get_or_create(name="Doubletalk", stat="manipulation")
WoDSpecialty.objects.get_or_create(name="Seduction", stat="manipulation")
WoDSpecialty.objects.get_or_create(name="Genial", stat="appearance")
...
WoDSpecialty.objects.get_or_create(name="Creative Logic", stat="intelligence")
...
WoDSpecialty.objects.get_or_create(name="Snappy Retorts", stat="wits")
WoDSpecialty.objects.get_or_create(name="Ambushes", stat="wits")
WoDSpecialty.objects.get_or_create(name="Cool-Headed", stat="wits")
WoDSpecialty.objects.get_or_create(name="Cunning", stat="wits")
WoDSpecialty.objects.get_or_create(name="Ambushes", stat="alertness")
WoDSpecialty.objects.get_or_create(name="Eavesdropping", stat="alertness")
WoDSpecialty.objects.get_or_create(name="Paranoia", stat="alertness")
WoDSpecialty.objects.get_or_create(name="Traps", stat="alertness")
WoDSpecialty.objects.get_or_create(name="Scents", stat="alertness")
WoDSpecialty.objects.get_or_create(name="Specific sports", stat="athletics")
WoDSpecialty.objects.get_or_create(name="Team Play", stat="athletics")
WoDSpecialty.objects.get_or_create(name="Swimming", stat="athletics")
WoDSpecialty.objects.get_or_create(name="Rock Climbing", stat="athletics")
WoDSpecialty.objects.get_or_create(name="Tumbling", stat="athletics")
WoDSpecialty.objects.get_or_create(name="Distance Trials", stat="athletics")
WoDSpecialty.objects.get_or_create(name="Pentathlon", stat="athletics")
WoDSpecialty.objects.get_or_create(name="Boxing", stat="brawl")
WoDSpecialty.objects.get_or_create(name="Wrestling", stat="brawl")
WoDSpecialty.objects.get_or_create(name="Dirty Infighting", stat="brawl")
WoDSpecialty.objects.get_or_create(name="Weaponless Martial Arts", stat="brawl")
WoDSpecialty.objects.get_or_create(name="Kailindo", stat="brawl")
WoDSpecialty.objects.get_or_create(name="Sense Lies", stat="empathy")
WoDSpecialty.objects.get_or_create(name="Hidden Motives", stat="empathy")
WoDSpecialty.objects.get_or_create(name="Emotional States", stat="empathy")
WoDSpecialty.objects.get_or_create(name="Personality Quirks", stat="empathy")
WoDSpecialty.objects.get_or_create(name="Affairs of the Heart", stat="empathy")
WoDSpecialty.objects.get_or_create(name="Rhetoric", stat="expression")
WoDSpecialty.objects.get_or_create(name="Inspiriting Speeches", stat="expression")
WoDSpecialty.objects.get_or_create(name="Poetry", stat="expression")
WoDSpecialty.objects.get_or_create(name="Drama", stat="expression")
WoDSpecialty.objects.get_or_create(name="Political Doubletalk", stat="expression")
...
WoDSpecialty.objects.get_or_create(name="Good Cop/Bad Cop", stat="intimidation")
WoDSpecialty.objects.get_or_create(name="Blackmail", stat="intimidation")
WoDSpecialty.objects.get_or_create(name="Phyiscal Threats", stat="intimidation")
WoDSpecialty.objects.get_or_create(name="Revenge", stat="intimidation")
WoDSpecialty.objects.get_or_create(name="Compelling", stat="leadership")
WoDSpecialty.objects.get_or_create(name="Open", stat="leadership")
WoDSpecialty.objects.get_or_create(name="Military", stat="leadership")
WoDSpecialty.objects.get_or_create(name="Motivation", stat="leadership")
WoDSpecialty.objects.get_or_create(name="Combat Readiness", stat="leadership")
WoDSpecialty.objects.get_or_create(name="Shifting Forms", stat="primal_urge")
WoDSpecialty.objects.get_or_create(name="Hunting", stat="primal_urge")
WoDSpecialty.objects.get_or_create(name="Hunches", stat="primal_urge")
WoDSpecialty.objects.get_or_create(name="Reacting", stat="primal_urge")
WoDSpecialty.objects.get_or_create(name="Fencing", stat="streetwise")
WoDSpecialty.objects.get_or_create(name="Illegal Drugs", stat="streetwise")
WoDSpecialty.objects.get_or_create(name="Illegal Guns", stat="streetwise")
WoDSpecialty.objects.get_or_create(name="Gangs", stat="streetwise")
WoDSpecialty.objects.get_or_create(name="Unsecured Wifi", stat="streetwise")
WoDSpecialty.objects.get_or_create(name="White Lies", stat="subterfuge")
...
WoDSpecialty.objects.get_or_create(name="Feigned Innocence", stat="subterfuge")
...
WoDSpecialty.objects.get_or_create(name="Feral Animals", stat="animal_ken")
WoDSpecialty.objects.get_or_create(name="Attack Training", stat="animal_ken")
WoDSpecialty.objects.get_or_create(name="Horses", stat="animal_ken")
WoDSpecialty.objects.get_or_create(name="Big Cats", stat="animal_ken")
WoDSpecialty.objects.get_or_create(name="Dogs", stat="animal_ken")
WoDSpecialty.objects.get_or_create(name="Woodwork", stat="crafts")
WoDSpecialty.objects.get_or_create(name="Drawing/Painting", stat="crafts")
WoDSpecialty.objects.get_or_create(name="Weaving", stat="crafts")
WoDSpecialty.objects.get_or_create(name="Carving", stat="crafts")
...
WoDSpecialty.objects.get_or_create(name="Auto Repair", stat="crafts")
WoDSpecialty.objects.get_or_create(name="Off-road", stat="drive")
WoDSpecialty.objects.get_or_create(name="Motorcycles", stat="drive")
WoDSpecialty.objects.get_or_create(name="Heavy Traffic", stat="drive")
WoDSpecialty.objects.get_or_create(name="High Speed", stat="drive")
WoDSpecialty.objects.get_or_create(name="High Society", stat="etiquette")
WoDSpecialty.objects.get_or_create(name="Moots", stat="etiquette")
WoDSpecialty.objects.get_or_create(name="Tribal", stat="etiquette")
WoDSpecialty.objects.get_or_create(name="Big Business", stat="etiquette")
...
WoDSpecialty.objects.get_or_create(name="Submachine Guns", stat="firearms")
WoDSpecialty.objects.get_or_create(name="Gunsmithing", stat="firearms")
WoDSpecialty.objects.get_or_create(name="Marksmanship", stat="firearms")
WoDSpecialty.objects.get_or_create(name="Trick Shots", stat="firearms")
...
WoDSpecialty.objects.get_or_create(name="Lockpicking", stat="larceny")
WoDSpecialty.objects.get_or_create(name="Hotwiring", stat="larceny")
WoDSpecialty.objects.get_or_create(name="Safecracking", stat="larceny")
WoDSpecialty.objects.get_or_create(name="Swords", stat="melee")
WoDSpecialty.objects.get_or_create(name="Spears", stat="melee")
WoDSpecialty.objects.get_or_create(name="Improvised Weaponry", stat="melee")
WoDSpecialty.objects.get_or_create(name="Klaives", stat="melee")
WoDSpecialty.objects.get_or_create(name="Dancing", stat="performance")
WoDSpecialty.objects.get_or_create(name="Singing", stat="performance")
WoDSpecialty.objects.get_or_create(name="Acting", stat="performance")
WoDSpecialty.objects.get_or_create(name="Rock and Roll", stat="performance")
WoDSpecialty.objects.get_or_create(name="Guitar Solos", stat="performance")
WoDSpecialty.objects.get_or_create(name="Opera", stat="performance")
WoDSpecialty.objects.get_or_create(name="Howling", stat="performance")
WoDSpecialty.objects.get_or_create(name="Shadowing", stat="stealth")
WoDSpecialty.objects.get_or_create(name="Urban", stat="stealth")
WoDSpecialty.objects.get_or_create(name="Taking Point", stat="stealth")
WoDSpecialty.objects.get_or_create(name="Crowds", stat="stealth")
WoDSpecialty.objects.get_or_create(name="Hiding Objects", stat="stealth")
...
WoDSpecialty.objects.get_or_create(name="Trapping", stat="survival")
WoDSpecialty.objects.get_or_create(name="Color Theory", stat="academics")
WoDSpecialty.objects.get_or_create(name="Linguistics", stat="academics")
WoDSpecialty.objects.get_or_create(name="Poststructuralism", stat="academics")
WoDSpecialty.objects.get_or_create(name="Ethics", stat="academics")
WoDSpecialty.objects.get_or_create(name="Metaphysics", stat="academics")
WoDSpecialty.objects.get_or_create(name="Sumeria", stat="academics")
WoDSpecialty.objects.get_or_create(name="Internet Research", stat="computer")
WoDSpecialty.objects.get_or_create(name="Video Editing", stat="computer")
WoDSpecialty.objects.get_or_create(name="Photo Manipulation", stat="computer")
WoDSpecialty.objects.get_or_create(name="Programming", stat="computer")
WoDSpecialty.objects.get_or_create(name="Computer Languages", stat="computer")
WoDSpecialty.objects.get_or_create(name="Logic Problems", stat="enigmas")
...
WoDSpecialty.objects.get_or_create(name="Evidence", stat="investigation")
WoDSpecialty.objects.get_or_create(name="Ballistics", stat="investigation")
WoDSpecialty.objects.get_or_create(name="Forensics", stat="investigation")
WoDSpecialty.objects.get_or_create(name="Fingerprints", stat="investigation")
WoDSpecialty.objects.get_or_create(name="Searches", stat="investigation")
WoDSpecialty.objects.get_or_create(name="Internet Research", stat="investigation")
WoDSpecialty.objects.get_or_create(name="Fitting Punishments", stat="law")
WoDSpecialty.objects.get_or_create(name="Litany Breaches", stat="law")
WoDSpecialty.objects.get_or_create(name="Human Field", stat="law")
WoDSpecialty.objects.get_or_create(name="Emergency Medicine", stat="medicine")
WoDSpecialty.objects.get_or_create(name="Forensic Pathology", stat="medicine")
WoDSpecialty.objects.get_or_create(name="Neurology", stat="medicine")
WoDSpecialty.objects.get_or_create(name="Pharmacology", stat="medicine")
WoDSpecialty.objects.get_or_create(name="Poison Treatments", stat="medicine")
WoDSpecialty.objects.get_or_create(name="Garou Physiology", stat="medicine")
WoDSpecialty.objects.get_or_create(name="Tarot", stat="occult")
WoDSpecialty.objects.get_or_create(name="Witchcraft", stat="occult")
WoDSpecialty.objects.get_or_create(name="Curses", stat="occult")
WoDSpecialty.objects.get_or_create(name="Ghosts", stat="occult")
WoDSpecialty.objects.get_or_create(name="Psychometry", stat="occult")
WoDSpecialty.objects.get_or_create(name="Garou Lore", stat="occult")
WoDSpecialty.objects.get_or_create(name="Accord", stat="rituals")
WoDSpecialty.objects.get_or_create(name="Caern", stat="rituals")
WoDSpecialty.objects.get_or_create(name="Death", stat="rituals")
WoDSpecialty.objects.get_or_create(name="Mystic", stat="rituals")
WoDSpecialty.objects.get_or_create(name="Punishment", stat="rituals")
WoDSpecialty.objects.get_or_create(name="Renown", stat="rituals")
WoDSpecialty.objects.get_or_create(name="Seasonal", stat="rituals")
WoDSpecialty.objects.get_or_create(name="Minor", stat="rituals")
...
WoDSpecialty.objects.get_or_create(name="Chemistry", stat="science")
WoDSpecialty.objects.get_or_create(name="Physics", stat="science")
WoDSpecialty.objects.get_or_create(name="Biology", stat="science")
WoDSpecialty.objects.get_or_create(name="Mathematics", stat="science")
WoDSpecialty.objects.get_or_create(name="Astronomy", stat="science")
WoDSpecialty.objects.get_or_create(name="Telecoms", stat="technology")
...
WoDSpecialty.objects.get_or_create(name="Communications", stat="technology")
WoDSpecialty.objects.get_or_create(name="Jury-Rigging", stat="technology")
WoDSpecialty.objects.get_or_create(name="Industrial Espionage", stat="technology")
...
Rite.objects.create(name="Rite of Cleansing", level=1, rite_type="accord")
Rite.objects.create(name="Rite of Contrition", level=1, rite_type="accord")
Rite.objects.create(name="Rite of Renunciation", level=2, rite_type="accord")
Rite.objects.create(name="Rite of the Loyal PAck", level=3, rite_type="accord")
Rite.objects.create(name="Enchant the Forest", level=4, rite_type="accord")
Rite.objects.create(name="Rite of the Opened Sky", level=4, rite_type="accord")
moot_rite = Rite.objects.create(name="Moot Rite", level=1, rite_type="caern")
Rite.objects.create(name="Rite of the Opened Caern", level=1, rite_type="caern")
Rite.objects.create(name="Rite of the Glorious Past", level=3, rite_type="caern")
Rite.objects.create(name="The Badger's Burrow", level=4, rite_type="caern")
Rite.objects.create(name="Rite of the Opened Bridge", level=4, rite_type="caern")
Rite.objects.create(name="Rite of the Shrouded Glen", level=4, rite_type="caern")
rite_of_caern_building = Rite.objects.create(
    name="Rite of Caern Building", level=5, rite_type="caern"
)
Rite.objects.create(name="Gathering for the Departed", level=1, rite_type="death")
Rite.objects.create(name="Last Blessing", level=1, rite_type="death")
Rite.objects.create(name="Rite of the Winter Wolf", level=3, rite_type="death")
Rite.objects.create(name="Baptism of Fire", level=1, rite_type="mystic")
Rite.objects.create(name="Rite of Binding", level=1, rite_type="mystic")
Rite.objects.create(name="Rite of Growth", level=1, rite_type="mystic")
Rite.objects.create(name="Rite of Heritage", level=1, rite_type="mystic")
Rite.objects.create(name="Rite of the Cardboard Palace", level=1, rite_type="mystic")
Rite.objects.create(name="Rite of the Questing Stone", level=1, rite_type="mystic")
Rite.objects.create(name="Rite of Talisman Dedication", level=1, rite_type="mystic")
Rite.objects.create(name="Rite of Becoming", level=2, rite_type="mystic")
Rite.objects.create(name="Rite of Spirit Awakening", level=2, rite_type="mystic")
Rite.objects.create(name="Rite of Summoning", level=2, rite_type="mystic")
Rite.objects.create(name="Rite of Sacred Rebirth", level=5, rite_type="mystic")
Rite.objects.create(name="Descent Into the Underworld", level=3, rite_type="mystic")
Rite.objects.create(name="Rite of the Fetish", level=3, rite_type="mystic")
Rite.objects.create(name="Rite of the Totem", level=3, rite_type="mystic")
Rite.objects.create(name="Rite of the Jackdaw", level=1, rite_type="punishment")
...
Rite.objects.create(name="The Hunt", level=3, rite_type="punishment")
Rite.objects.create(name="Rite of the Omega Wolf", level=3, rite_type="punishment")
Rite.objects.create(name="Satire Rite", level=3, rite_type="punishment")
...
Rite.objects.create(name="The Great Hunt", level=2, rite_type="seasonal")
Rite.objects.create(name="The Long Vigil", level=3, rite_type="seasonal")
Rite.objects.create(name="Bone Rhythms", level=0, rite_type="minor")
Rite.objects.create(name="Breath of Gaia", level=0, rite_type="minor")
Rite.objects.create(name="Greet the Moon", level=0, rite_type="minor")
Rite.objects.create(name="Greet the Sun", level=0, rite_type="minor")
Rite.objects.create(name="Hunting Prayer", level=0, rite_type="minor")
Rite.objects.create(name="Prayer for the Prey", level=0, rite_type="minor")
...
FomoriPower.objects.create(name="Animal Control")
FomoriPower.objects.create(name="Armored Hide")
FomoriPower.objects.create(name="Armored Skin")
FomoriPower.objects.create(name="Berserker")
FomoriPower.objects.create(name="Bestial Mutation")
FomoriPower.objects.create(name="Body-Barbs")
FomoriPower.objects.create(name="Body Expansion")
FomoriPower.objects.create(name="Brain Eating")
FomoriPower.objects.create(name="Cancerous Carapace")
FomoriPower.objects.create(name="Cause Insanity")
FomoriPower.objects.create(name="Chameleon Coloration")
FomoriPower.objects.create(name="Claws and Fangs")
FomoriPower.objects.create(name="Darksight")
FomoriPower.objects.create(name="Deception")
FomoriPower.objects.create(name="Dentata Orifice")
FomoriPower.objects.create(name="Echoes of Wrath")
FomoriPower.objects.create(name="Ectoplasmic Extrusion")
FomoriPower.objects.create(name="Exoskeleton")
FomoriPower.objects.create(name="Extra Limbss")
FomoriPower.objects.create(name="Extra Speed")
FomoriPower.objects.create(name="Eyes of the Wyrm")
FomoriPower.objects.create(name="Fiery Discharge")
FomoriPower.objects.create(name="Footpads")
FomoriPower.objects.create(name="Frog Tongue")
FomoriPower.objects.create(name="Fungal Touch")
FomoriPower.objects.create(name="Fungal Udder")
FomoriPower.objects.create(name="Gaseous Form")
FomoriPower.objects.create(name="Gifted Fomor")
FomoriPower.objects.create(name="Hazardous Breath")
FomoriPower.objects.create(name="Hazardous Heave")
FomoriPower.objects.create(name="Hell's Hide")
FomoriPower.objects.create(name="Homogeneity")
FomoriPower.objects.create(name="Immunity to the Delirium")
FomoriPower.objects.create(name="Infectious Touch")
FomoriPower.objects.create(name="Invisibility")
FomoriPower.objects.create(name="Lashing Tail")
FomoriPower.objects.create(name="Malleate")
FomoriPower.objects.create(name="Maw of the Wyrm")
FomoriPower.objects.create(name="Mega-Attribute")
FomoriPower.objects.create(name="Mind Blast")
FomoriPower.objects.create(name="Molecular Weakening")
FomoriPower.objects.create(name="Numbleness")
FomoriPower.objects.create(name="Noxious Breath")
FomoriPower.objects.create(name="Noxious Miasma")
FomoriPower.objects.create(name="Numbing")
FomoriPower.objects.create(name="Phoenix Form")
FomoriPower.objects.create(name="Poison Tumors")
FomoriPower.objects.create(name="Rat Head")
FomoriPower.objects.create(name="Regeneration")
FomoriPower.objects.create(name="Roar of the Wyrm")
FomoriPower.objects.create(name="Sense Gaia")
FomoriPower.objects.create(name="Sense the Unnatural")
FomoriPower.objects.create(name="Shadowplay")
FomoriPower.objects.create(name="Size Shift")
FomoriPower.objects.create(name="Skittersight")
FomoriPower.objects.create(name="Slither Skin")
FomoriPower.objects.create(name="Slobbersnot")
FomoriPower.objects.create(name="Spirit Ties")
FomoriPower.objects.create(name="Stomach Pumper")
FomoriPower.objects.create(name="Tar Skin")
FomoriPower.objects.create(name="Toxic Secretions")
FomoriPower.objects.create(name="Triatic Sense")
FomoriPower.objects.create(name="Twisted Senses")
FomoriPower.objects.create(name="Umbral Passage")
FomoriPower.objects.create(name="Unnatural Strength")
FomoriPower.objects.create(name="Venomous Bite")
FomoriPower.objects.create(name="Viscous Form")
FomoriPower.objects.create(name="Voice of the Wyrm")
FomoriPower.objects.create(name="Wall Walking")
FomoriPower.objects.create(name="Water Breathing")
