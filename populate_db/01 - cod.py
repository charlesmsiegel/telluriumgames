...
Merit.objects.create(
    name="Fast Reflexes (Wits)",
    ratings=[1, 2, 3],
    prereqs=[[("wits", 3)]],
    merit_type="Mental",
)
Merit.objects.create(
    name="Fast Reflexes (Dexterity)",
    ratings=[1, 2, 3],
    prereqs=[[("dexterity", 3)]],
    merit_type="Mental",
)
...
Merit.objects.create(
    name="Taste",
    ratings=[1],
    prereqs=[[("crafts", 2), ("crafts", "specialty")]],
    merit_type="Social",
)
Merit.objects.create(
    name="Taste",
    ratings=[1],
    prereqs=[[("crafts", 2), ("expression", "specialty")]],
    merit_type="Social",
)
Merit.objects.create(
...
Merit.objects.create(
    name="Iron Skin",
    ratings=[2, 4],
    prereqs=[[("stamina", 3), ("Martial Arts", 2)]],
    merit_type="Fighting",
)
Merit.objects.create(
    name="Iron Skin",
    ratings=[2, 4],
    prereqs=[[("stamina", 3), ("Street Fighting", 2)]],
    merit_type="Fighting",
)
Merit.objects.create(
    name="Light Weapons",
...
Merit.objects.create(
    ...
    is_style=True,
    ratings=[1, 2, 3, 4, 5],
    prereqs=[[("dexterity", 3), ("athletics", 2), ("weaponry", 2), ("Fighting Finesse", 1)]],
    merit_type="Fighting",
)
Merit.objects.create(
    name="Marksmanship",
