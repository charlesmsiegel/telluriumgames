...
MeritFlaw.objects.create(
    name="Acute Sense (Werewolf)", ratings=[1], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Alcohol Tolerance", ratings=[1], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Ambidextrous", ratings=[1], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Double-Jointed", ratings=[1], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(name="Mixed-morph", ratings=[1, 5], human=True, garou=True)
MeritFlaw.objects.create(
    name="Perfect Balance", ratings=[1], human=True, garou=True, kinfolk=True
)
...
MeritFlaw.objects.create(
    name="Huge Size", ratings=[4], human=True, garou=True, mage=True, kinfolk=True
)
...
MeritFlaw.objects.create(
    name="Short (Werewolf)", ratings=[-1], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Bad Sight", ratings=[-3], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Lame", ratings=[-3], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Common Sense", ratings=[1], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Concentration", ratings=[1], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Expert Driver", ratings=[1], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Language", ratings=[1], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Eidetic Memory", ratings=[2], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Iron Will", ratings=[3], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Jack-of-all-Trades", ratings=[3], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Impatient", ratings=[-1], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Intolerance", ratings=[-1], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Nightmares (Werewolf)", ratings=[-1], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Soft-Hearted", ratings=[-1], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Amnesia", ratings=[-2], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Curiosity", ratings=[-2], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Pack Mentality", ratings=[-2], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Phobia", ratings=[-2, -3], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Short Fuse", ratings=[-2], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Territorial", ratings=[-2], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Vengeful", ratings=[-2], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Absent-Minded", ratings=[-3], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Weak-Willed", ratings=[-3], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Reputation", ratings=[2], human=True, garou=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Dark Secret", ratings=[-1], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Enemy",
    ratings=[-1, -2, -3, -4, -5],
...
MeritFlaw.objects.create(
    name="Ward", ratings=[-3], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Hunted", ratings=[-4], human=True, garou=True, kinfolk=True
)
...
MeritFlaw.objects.create(
    name="Danger Sense", ratings=[3], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Lucky", ratings=[3], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="Natural Channel", ratings=[3], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
    name="True Love", ratings=[4], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(
    name="Dark Fate", ratings=[-5], human=True, garou=True, mage=True, kinfolk=True
)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(name="Addiction", ratings=[-1, -3], human=True, mage=True)
...
MeritFlaw.objects.create(
    name="Echoes", ratings=[-1, -2, -3, -4, -5], human=True, mage=True
)
...
MeritFlaw.objects.create(name="Medium", ratings=[2], human=True, mage=True)
...
MeritFlaw.objects.create(name="Nightsight", ratings=[3], human=True, mage=True)
...
MeritFlaw.objects.create(name="Poison Resistance", ratings=[2], human=True, mage=True)
...
MeritFlaw.objects.create(name="Rising Star", ratings=[3], human=True, mage=True)
...
MeritFlaw.objects.create(name="Bard's Tongue", ratings=[-1], human=True, mage=True)
...
MeritFlaw.objects.create(name="Flashbacks (Mage)", ratings=[-3], human=True, mage=True)
MeritFlaw.objects.create(
...
MeritFlaw.objects.create(name="Haunted", ratings=[-3], human=True, mage=True)
...
MeritFlaw.objects.create(name="Lifesaver", ratings=[-3], human=True, mage=True)
...
MeritFlaw.objects.create(name="Psychic Vampire", ratings=[-5], human=True, mage=True)
...
MeritFlaw.objects.create(
    name="Sleeping with the Enemy", ratings=[-3], human=True, mage=True
)
...
MeleeWeapon.objects.create(name="Sap", difficulty=4, damage=0, damage_type="B", conceal="P", display=False)
MeleeWeapon.objects.create(name="Whip", difficulty=6, damage=1, damage_type="L", conceal="J", display=False)
MeleeWeapon.objects.create(name="Spiked Gauntlet", difficulty=6, damage=1, damage_type="L", conceal="J", display=False)
MeleeWeapon.objects.create(name="Broken Bottle", difficulty=6, damage=1, damage_type="L", conceal="P", display=False)
MeleeWeapon.objects.create(name="Chair", difficulty=7, damage=2, damage_type="B", conceal="N", display=False)
MeleeWeapon.objects.create(name="Table", difficulty=8, damage=3, damage_type="B", conceal="N", display=False)
MeleeWeapon.objects.create(name="Chain", difficulty=5, damage=0, damage_type="B", conceal="J", display=False)
MeleeWeapon.objects.create(name="Staff", difficulty=5, damage=1, damage_type="B", conceal="N", display=False)
MeleeWeapon.objects.create(name="Mace", difficulty=6, damage=2, damage_type="L", conceal="N", display=False)
MeleeWeapon.objects.create(name="Baseball Bat", difficulty=5, damage=2, damage_type="B", conceal="T", display=False)
MeleeWeapon.objects.create(name="Spiked Club", difficulty=6, damage=2, damage_type="L", conceal="T", display=False)
MeleeWeapon.objects.create(name="Huge Spiked Club", difficulty=7, damage=4, damage_type="L", conceal="N", display=False)
MeleeWeapon.objects.create(name="Knife", difficulty=4, damage=1, damage_type="L", conceal="P", display=False)
MeleeWeapon.objects.create(name="Sword", difficulty=6, damage=2, damage_type="L", conceal="T", display=False)
...
MeleeWeapon.objects.create(name="Great Sword", difficulty=7, damage=6, damage_type="L", conceal="N", display=False)
MeleeWeapon.objects.create(name="Axe", difficulty=7, damage=3, damage_type="L", conceal="T", display=False)
MeleeWeapon.objects.create(name="Great Axe", difficulty=7, damage=6, damage_type="L", conceal="N", display=False)
MeleeWeapon.objects.create(name="Polearm", difficulty=7, damage=3, damage_type="L", conceal="N", display=False)
MeleeWeapon.objects.create(name="Chainsaw", difficulty=8, damage=7, damage_type="L", conceal="N", display=False)


ThrownWeapon.objects.create(name="Throwing Knife", difficulty=6, damage=0, damage_type="L", conceal="P", display=False)
ThrownWeapon.objects.create(name="Shuriken", difficulty=7, damage=3, damage_type="L", conceal="P", display=False)
ThrownWeapon.objects.create(name="Spear", difficulty=6, damage=1, damage_type="L", conceal="N", display=False)
ThrownWeapon.objects.create(name="Stone", difficulty=5, damage=0, damage_type="B", conceal="N", display=False)
ThrownWeapon.objects.create(name="Stone, head-sized", difficulty=6, damage=3, damage_type="B", conceal="N", display=False)
ThrownWeapon.objects.create(name="Tomahawk", difficulty=6, damage=1, damage_type="L", conceal="J", display=False)

RangedWeapon.objects.create(name="Revolver, Lt.", damage=4, range=12, rate=3, clip=6, conceal="P", display=False)
RangedWeapon.objects.create(name="Revolver, Hvy.", damage=6, range=35, rate=2, clip=6, conceal="J", display=False)
RangedWeapon.objects.create(name="Semi-Automatic Pistol, Lt.", damage=4, range=20, rate=4, clip=18, conceal="P", display=False)
RangedWeapon.objects.create(name="Semi-Automatic Pistol, Hvy.", damage=5, range=25, rate=3, clip=14, conceal="J", display=False)
RangedWeapon.objects.create(name="Rifle", damage=8, range=200, rate=1, clip=6, conceal="N", display=False)
RangedWeapon.objects.create(name="SMG, Small", damage=4, range=25, rate=3, clip=31, conceal="J", display=False)
RangedWeapon.objects.create(name="SMG, Large", damage=4, range=50, rate=3, clip=31, conceal="T", display=False)
RangedWeapon.objects.create(name="Assault Rifle", damage=7, range=150, rate=3, clip=31, conceal="N", display=False)
RangedWeapon.objects.create(name="Shotgun, Sawed-Off", damage=8, range=10, rate=2, clip=2, conceal="J", display=False)
RangedWeapon.objects.create(name="Shotgun", damage=8, range=20, rate=1, clip=6, conceal="T", display=False)
RangedWeapon.objects.create(name="Shotgun, Semi-Automatic", damage=8, range=25, rate=3, clip=7, conceal="T", display=False)
RangedWeapon.objects.create(name="Shotgun, Assault", damage=8, range=50, rate=0, clip=33, conceal="N", display=False)
RangedWeapon.objects.create(name="Short Bow", damage=4, range=60, rate=1, clip=1, conceal="N", display=False)
RangedWeapon.objects.create(name="Hunting Bow", damage=5, range=100, rate=1, clip=1, conceal="N", display=False)
RangedWeapon.objects.create(name="Long Bow", damage=5, range=120, rate=1, clip=1, conceal="N", display=False)
RangedWeapon.objects.create(name="Crossbow, Commando", damage=3, range=20, rate=1, clip=1, conceal="J", display=False)
RangedWeapon.objects.create(name="Crossbow", damage=5, range=90, rate=1, clip=1, conceal="T", display=False)
RangedWeapon.objects.create(name="Crossbow, Hvy.", damage=6, range=100, rate=1, clip=1, conceal="N", display=False)
RangedWeapon.objects.create(name="Taser", damage=5, range=5, rate=1, clip=1, conceal="P", display=False)
RangedWeapon.objects.create(name="Tear Gas", damage=3, range=3, rate=1, clip=5, conceal="P", display=False)
RangedWeapon.objects.create(name="Bear Mace", damage=4, range=3, rate=1, clip=3, conceal="P", display=False)
