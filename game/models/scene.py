...
class Scene(models.Model):
    ...
    characters = models.ManyToManyField("core.CharacterModel", related_name="scenes", blank=True)
    location = models.ForeignKey("core.LocationModel", on_delete=models.CASCADE, null=True)
